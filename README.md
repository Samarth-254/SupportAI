...
> [!NOTE]
> This is the client-side frontend repository. For the server-side logic (RAG hybrid search, local vector embeddings, text chunking, and Groq SDK resolution), check out the [Backend API Repository]([https://github.com/Samarth-254/Chatbot-backend](https://github.com/Samarth-254/SupportAI-Backend)).
